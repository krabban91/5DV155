	...
	//Some defaults for audio recorder
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['AudioRecorder','ResourceSearch', 'kaltura', 'Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula']
                : ['kaltura', 'AudioRecorder','Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula','Video','pbckcode']),
            '/',
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('video',basePath+'video/', 'plugin.js');
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="audiorecorder,movieplayer,wordcount,fmath_formula,video";
			 ckconfig.extraPlugins+=",kaltura";
                         
             CKEDITOR.plugins.addExternal('pbckcode',basePath+'pbckcode/', 'plugin.js');
			 ckconfig.extraPlugins+=",pbckcode";
			 
			 // umu fonts
             ckconfig.contentsCss = '/library/fonts/fonts.css';
             ckconfig.font_names = CKEDITOR.config.font_names + ';SPIonic/spionic;';
    })();
